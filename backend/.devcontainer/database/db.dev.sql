...
create table if not exists tb_sales (id int8 generated by default as identity, amount float8, date date, deals int4, visited int4, seller_id int8, primary key (id));
create table if not exists tb_sellers (id int8 generated by default as identity, name varchar(255), primary key (id));
